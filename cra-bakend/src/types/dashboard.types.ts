// src/types/dashboard.types.ts - Version améliorée
export interface DashboardResponse {
  ...
  forms?: {
    ...
    // Pour ASSISTANT_CHERCHEUR, CHERCHEUR
    participation?: {
  ...
  summary: {
    ...
    // Nouvelle métrique pour les formulaires
...
export interface DashboardQuery {
  ...
  formsPeriod?: number; // nombre de jours
}

// Nouvelles interfaces pour les métriques spécialisées
