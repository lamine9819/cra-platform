// utils/formation-report.service.ts
...
export class FormationReportService {
  /**
   ...
   */
  private generateShortTrainingsReceivedSection(trainings: any[]): string {
   ...
   */
  private generateDiplomaticTrainingsReceivedSection(trainings: any[]): string {
    if (trainings.length === 0) {
      return `
        <div class="section">
   ...
   */
  private generateTrainingsGivenSection(trainings: any[]): string {
    if (trainings.length === 0) {
      return `
        <div class="section">
   ...
   */
  private generateSupervisionsSection(supervisions: any[]): string {
   ...
   */
  private getTrainingTypeLabel(type: string): string {
