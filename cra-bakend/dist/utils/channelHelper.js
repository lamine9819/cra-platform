...
exports.addUserToGeneralChannel = addUserToGeneralChannel;
exports.ensureGeneralChannelExists = ensureGeneralChannelExists;
 ...
 */
async function addUserToGeneralChannel(userId) {
    try {
 ...
 */
async function ensureGeneralChannelExists(creatorId) {
    try {
