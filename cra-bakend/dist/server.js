...
exports.webSocketService = exports.app = exports.server = void 0;
    ...
    const scheduleWeeklyMaintenance = () => {
        ...
        setTimeout(async () => {
            try {
                ...
                const { AuditService } = await Promise.resolve().then(() => tslib_1.__importStar(require('./services/audit.service')));
...
if (NODE_ENV === 'development') {
    ...
    app_1.default.post('/dev/restart-services', (req, res) => {
    ...
    app_1.default.get('/dev/stats', (req, res) => {
        const wsService = (0, websocketNotification_service_1.getWebSocketService)();
        const memUsage = process.memoryUsage();
        res.json({
            server: {
    ...
    app_1.default.post('/dev/test-notification', (req, res) => {
        const wsService = (0, websocketNotification_service_1.getWebSocketService)();
        if (!wsService) {
