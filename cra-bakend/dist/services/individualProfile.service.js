...
exports.IndividualProfileService = void 0;
...
class IndividualProfileService {
     ...
     */
    async generateIndividualProfileDocument(userId, format = 'pdf') {
        ...
        if (user.role !== 'CHERCHEUR') {
            throw new errors_1.ValidationError('Seuls les chercheurs ont une fiche individuelle');
        }
     ...
     */
    async generatePDFFicheIndividuelle(user) {
        return new Promise((resolve, reject) => {
            try {
                ...
                const addRow = (label, value, x, y, width = 180) => {
                    doc.fontSize(9)
                        .font('Helvetica')
   ...
   * Générer une fiche individuelle en Word (DOCX)
   */
    async generateWordFicheIndividuelle(user) {
        const profile = user.individualProfile;
            ...
            sections: [{
                    ...
                    children: [
                        ...
                        new docx_1.Paragraph({
                            children: [new docx_1.TextRun({ text: 'FICHE INDIVIDUELLE 5', bold: true, size: 28 })],
                                    ...
                                    children: [
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'CODE FICHE : ', size: 18 }),
                                                        new docx_1.TextRun({ text: user.id.substring(0, 8).toUpperCase(), bold: true, size: 18 })
                                                    ]
                                                })],
                                        ...
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'GRADE : ', size: 18 }),
                                                        new docx_1.TextRun({ text: profile.grade, bold: true, size: 18 })
                                                    ]
                                                })],
                                        ...
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'CLASSE : ', size: 18 }),
                                                        new docx_1.TextRun({ text: profile.classe || 'N/A', bold: true, size: 18 })
                                                    ]
                                                })],
                                            width: { size: 25, type: docx_1.WidthType.PERCENTAGE },
                                        }),
                                ...
                                new docx_1.TableRow({
                                    children: [
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'MATRICULE : ', size: 18 }),
                                                        new docx_1.TextRun({ text: profile.matricule, bold: true, size: 18 })
                                                    ]
                                                })],
                                        }),
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'DATE NAISSANCE : ', size: 18 }),
                                                        new docx_1.TextRun({ text: this.formatDate(profile.dateNaissance), bold: true, size: 18 })
                                                    ]
                                                })],
                                            columnSpan: 2,
                                        }),
                                ...
                                new docx_1.TableRow({
                                    children: [
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'CHERCHEUR : ', size: 18 }),
                                                        new docx_1.TextRun({ text: `${user.firstName} ${user.lastName}`, bold: true, size: 18 })
                                                    ]
                                                })],
                                        }),
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'DATE RECRUTEMENT : ', size: 18 }),
                                                        new docx_1.TextRun({ text: this.formatDate(profile.dateRecrutement), bold: true, size: 18 })
                                                    ]
                                                })],
                                            columnSpan: 2,
                                        }),
                                ...
                                new docx_1.TableRow({
                                    children: [
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'CENTRE : ', size: 18 }),
                                                        new docx_1.TextRun({ text: 'Centre de Recherches Agricoles de Saint-Louis', bold: true, size: 18 })
                                                    ]
                                                })],
                                            columnSpan: 3,
                                        }),
                                ...
                                new docx_1.TableRow({
                                    children: [
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'LOCALITÉ : ', size: 18 }),
                                                        new docx_1.TextRun({ text: profile.localite, bold: true, size: 18 })
                                                    ]
                                                })],
                                        }),
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'DIPLÔME : ', size: 18 }),
                                                        new docx_1.TextRun({ text: profile.diplome, bold: true, size: 18 })
                                                    ]
                                                })],
                                            columnSpan: 2,
                                        }),
                                ...
                                new docx_1.TableRow({
                                    children: [
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [
                                                        new docx_1.TextRun({ text: 'DISCIPLINE : ', size: 18 }),
                                                        new docx_1.TextRun({ text: user.discipline || 'N/A', bold: true, size: 18 })
                                                    ]
                                                })],
                                            columnSpan: 3,
                                        }),
                        ...
                        // ===== Espace =====
                        new docx_1.Paragraph({ text: '', spacing: { after: 300 } }),
                        // ===== Titre Répartition du temps =====
                        new docx_1.Paragraph({
                            children: [new docx_1.TextRun({ text: "Répartition du temps du chercheur par type d'activité", bold: true })],
                            alignment: docx_1.AlignmentType.CENTER,
                            spacing: { after: 200 },
                        }),
                            ...
                            rows: [
                                ...
                                new docx_1.TableRow({
                                    children: [
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [new docx_1.TextRun({ text: "TYPE D'ACTIVITÉ", bold: true })],
                                                    alignment: docx_1.AlignmentType.CENTER,
                                                })],
                                            shading: { fill: 'E2E8F0' },
                                        ...
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [new docx_1.TextRun({ text: 'TEMPS EN %', bold: true })],
                                                    alignment: docx_1.AlignmentType.CENTER,
                                                })],
                                            shading: { fill: 'E2E8F0' },
                                ...
                                new docx_1.TableRow({
                                    children: [
                                        new docx_1.TableCell({
                                            children: [new docx_1.Paragraph({
                                                    children: [new docx_1.TextRun({ text: 'TOTAL (le total doit faire 100 %) :', bold: true })],
                                                })],
                                            shading: { fill: 'E2E8F0' },
                                        }),
                                        new docx_1.TableCell({
                        ...
                        // ===== Signature =====
                        new docx_1.Paragraph({
                            children: [new docx_1.TextRun({ text: 'SIGNATURE DU CHERCHEUR', bold: true })],
                            spacing: { after: 600 },
                        }),
                        new docx_1.Paragraph({
                            children: [
                                new docx_1.TextRun({ text: 'DATE : __/__/' }),
                                new docx_1.TextRun({ text: new Date().getFullYear().toString(), bold: true }),
                            ],
                        }),
                    ],
                }],
     ...
     */
    createTimeRow(label, value) {
        return new docx_1.TableRow({
            children: [
                new docx_1.TableCell({
                    children: [
                        new docx_1.Paragraph({
                            children: [new docx_1.TextRun({ text: label, size: 18 })],
                        }),
                    ],
                }),
                new docx_1.TableCell({
                    children: [
                        new docx_1.Paragraph({
                            children: [new docx_1.TextRun({ text: value.toString(), bold: true, size: 18 })],
                            alignment: docx_1.AlignmentType.CENTER,
                        }),
                    ],
                }),
...
exports.IndividualProfileService = IndividualProfileService;
//# sourceMappingURL=individualProfile.service.js.map