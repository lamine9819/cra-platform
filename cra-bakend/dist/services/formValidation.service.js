...
class FormValidationService {
     ...
     */
    static validateFormResponse(formSchema, responseData) {
        const errors = [];
        const warnings = [];
        const sanitizedData = {};
     ...
     * Validation par type de champ
     */
    static validateByType(field, value) {
        switch (field.type) {
            case 'email':
     ...
     * Validation des contraintes personnalisées
     */
    static validateConstraints(field, value) {
        if (!field.validation) {
            return { isValid: true, sanitizedValue: value };
        }
     ...
     */
    static validateEmail(field, value) {
        if (typeof value !== 'string') {
            return {
                isValid: false,
    ...
    static validateNumber(field, value) {
        const numValue = Number(value);
        if (isNaN(numValue)) {
            return {
                isValid: false,
    ...
    static validateTime(field, value) {
    ...
    static validateSelection(field, value) {
    ...
    static validateFile(field, value) {
     ...
     */
    static validateBusinessRules(_formSchema, _data) {
        const errors = [];
        const warnings = [];
    ...
    static sanitizeValue(field, value) {
     ...
     */
    static validateFormSchema(schema) {
        const errors = [];
     ...
     */
    static validateFieldSchema(field, index) {
        const errors = [];
