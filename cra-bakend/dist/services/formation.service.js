...
class FormationService {
    ...
    async createShortTrainingReceived(userId, data) {
    ...
    async createDiplomaticTrainingReceived(userId, data) {
        const training = await prisma.training.create({
            data: {
    ...
    async deleteShortTrainingReceived(trainingId, userId) {
    ...
    async deleteDiplomaticTrainingReceived(trainingId, userId) {
        // Vérifier que la formation appartient à l'utilisateur
        const training = await prisma.training.findFirst({
            where: {
                id: trainingId,
    ...
    async deleteTrainingGiven(trainingId, userId) {
        // Vérifier que la formation appartient à l'utilisateur
        const training = await prisma.training.findFirst({
            where: {
                id: trainingId,
    ...
    async deleteSupervision(supervisionId, userId) {
    ...
    async createTrainingGiven(userId, data) {
        const training = await prisma.training.create({
            data: {
                title: data.title,
    ...
    // ============= ENCADREMENTS =============
    async createSupervision(supervisorId, data) {
    ...
    async getUserShortTrainingsReceived(userId) {
        ...
        return trainings.map(training => ({
            ...
            duration: training.duration,
            period: this.formatPeriod(training.startDate, training.endDate),
            beneficiaries: Array.isArray(training.beneficiaries) ? training.beneficiaries : [],
            organizer: training.organizer,
            createdAt: training.createdAt,
            updatedAt: training.updatedAt,
            activity: training.activity
    ...
    async getUserDiplomaticTrainingsReceived(userId) {
        const trainings = await prisma.training.findMany({
            where: {
                participants: {
                    some: {
    ...
    async getUserTrainingsGiven(userId) {
        const trainings = await prisma.training.findMany({
            where: {
                participants: {
                    some: {
    ...
    async getUserSupervisions(userId) {
    ...
    // ============= RAPPORTS =============
    async getAllUsersFormationReport() {
    ...
    async updateShortTrainingReceived(trainingId, userId, data) {
        // Vérifier que la formation appartient à l'utilisateur
    ...
    async updateDiplomaticTrainingReceived(trainingId, userId, data) {
        // Vérifier que la formation appartient à l'utilisateur
        const existingTraining = await prisma.training.findFirst({
            where: {
                id: trainingId,
    ...
    async updateTrainingGiven(trainingId, userId, data) {
        // Vérifier que la formation appartient à l'utilisateur
        const existingTraining = await prisma.training.findFirst({
            where: {
                id: trainingId,
    ...
    async updateSupervision(supervisionId, userId, data) {
        // Vérifier que l'encadrement appartient à l'utilisateur
