...
exports.DocumentServiceNewMethods = void 0;
const client_1 = require("@prisma/client");
const errors_1 = require("../utils/errors");
const fileHelpers_1 = require("../utils/fileHelpers");
const prisma = new client_1.PrismaClient();
class DocumentServiceNewMethods {
    // =============================================
    ...
    async canDeleteDocument(documentId, userId, userRole) {
        const document = await prisma.document.findUnique({
            where: { id: documentId },
            include: {
                shares: {
    ...
    async updateDocumentMetadata(documentId, updateData, userId, userRole) {
        ...
        if (!existingDocument) {
            throw new errors_1.NotFoundError('Document non trouvé');
        }
    ...
    async linkDocument(documentId, linkData, userId, userRole) {
        ...
        if (!entity) {
            throw new errors_1.NotFoundError(`${linkData.entityType} non trouvé(e)`);
        }
        // Lier le document
     ...
     */
    async softDeleteDocument(documentId, userId, userRole) {
        // Vérifier les permissions
        const canDelete = await this.canDeleteDocument(documentId, userId, userRole);
        if (!canDelete) {
            throw new errors_1.AuthError('Vous n\'avez pas la permission de supprimer ce document');
        }
        // Soft delete
...
exports.DocumentServiceNewMethods = DocumentServiceNewMethods;
exports.default = DocumentServiceNewMethods;
//# sourceMappingURL=document.service.NEW_METHODS.js.map