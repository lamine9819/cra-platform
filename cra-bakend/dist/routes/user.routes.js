...
router.post('/', (0, authorization_1.authorize)(['ADMINISTRATEUR', 'CHERCHEUR']), userController.createUser);
...
router.patch('/:userId/supervisor', (0, authorization_1.authorize)(['ADMINISTRATEUR', 'CHERCHEUR']), userController.assignSupervisor);
// =============================================
...
router.patch('/:userId/time-allocation', (0, authorization_1.authorize)(['ADMINISTRATEUR', 'COORDONATEUR_PROJET', 'CHERCHEUR']), userController.updateTimeAllocation);
