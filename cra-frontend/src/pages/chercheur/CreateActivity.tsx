...
import { ArrowLeft, Plus, X, Save, Calendar, MapPin, Target, FileText, Lightbulb } from 'lucide-react';
import activitiesApi, { CreateActivityRequest } from '../../services/activitiesApi';
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Créez une nouvelle activité de recherche
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
            ...
            Résultats et conclusions (optionnel)
          </h2>
